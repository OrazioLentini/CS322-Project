...
define([ "jquery","backbone", "../models/CategoryModel", "../collections/CategoriesCollection", "../views/CategoryView" ], function( $, Backbone, CategoryModel, CategoriesCollection, CategoryView ) {
    ...
    var CategoryRouter = Backbone.Router.extend( {
        ...
        initialize: function() {
            ...
            this.canonView = new CategoryView( { el: "#canon", collection: new CategoriesCollection( [] , { type: "canon" } ) } );

            // Instantiates a new Colors Category View
            this.nikonView = new CategoryView( { el: "#nikon", collection: new CategoriesCollection( [] , { type: "nikon" } ) } );

            // Instantiates a new Vehicles Category View
            this.sonyView = new CategoryView( { el: "#sony", collection: new CategoriesCollection( [] , { type: "sony" } ) } );
